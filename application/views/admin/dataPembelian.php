...
<div class="container-fluid" style="height: 100vh;">
    ...
    <!-- Page Heading -->
    <form action="<?php echo base_url('piList') ?>" method="post">
        <div class="row">
            ...
            <div class="col-md-2">
                <a style="float: right;" href="<?= base_url('addDataPi') ?>" class="btn btn-sm btn-outline-primary" type="button" id="addData"><i class="bi bi-plus"></i> Data </a>
            </div>
        </div>
    </form>
        ...
        <table class="table table-sm table-hover table-bordered">
            <thead>
                <tr style="text-transform: uppercase; font-size: 13px; background: #ececec;">
                    ...
                    <th style="width:80px; text-align:left;">Suplier</th>
            ...
            <tbody>
                <?php foreach ($data['dataPembelian'] as $key => $val) { ?>
                    <tr style="font-size: 13px;">
                        ...
                        <td style="text-align: center;">
                            <a href="<?= base_url('editDataPi/') . $val['nomor'] ?>" class="text-warning bg-white"><i class="bi bi-pencil"></i></a> &nbsp;
