...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h3 class="h4 mb-0 text-gray-800">Tambah <?= $data['title'] ?></h3>
    </div>
    <hr>
    <br>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" id="nomor" name="nomor" class="form-control" placeholder="BL-XXXX/XX-XXXX" readonly>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label for="suplier" class="text-dark">Suplier</label>
                    <select name="suplier" id="suplier" class="form-select">
                        <option value="">Pilih</option>
                        <?php foreach ($data['splInfo'] as $spl) { ?>
                            <option value="<?= $spl['kode'] ?>"><?= $spl['kode'] . ' - ' . $spl['nama'] ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="form-group">
                    ...
                    <input type="text" id="keterangan" name="keterangan" class="form-control" autocomplete="off" placeholder="Tambahkan text...">
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select name="kode_pesanan" id="kode_pesanan" class="form-select">
                            ...
                            <?php foreach ($data['psnInfo'] as $spl) { ?>
                                <option value="<?= $spl['kode'] ?>"><?= FormatNo_($spl['kode']) ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
    ...
    <section class="row" style="float: right;">
        <a href="<?= base_url('piList') ?> " class="btn btn-warning" style="width: 120px;">Kembali</a>&nbsp;
