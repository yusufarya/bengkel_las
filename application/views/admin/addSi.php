        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" id="nomor" name="nomor" class="form-control" placeholder="JL-XXXX/XX-XXXX" readonly>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                ...
                <div class="form-group" style="display: block;">
                    ...
                    <select name="pelanggan" id="pelanggan" class="form-select">
                        ...
                        <?php foreach ($data['plgInfo'] as $plg) { ?>
                            <option value="<?= $plg['kode'] ?>"><?= $plg['kode'] . ' - ' . $plg['nama'] ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select name="kode_pesanan" id="kode_pesanan" class="form-select">
                            ...
                            <?php foreach ($data['psnInfo'] as $psn) { ?>
                                <option value="<?= $psn['kode'] ?>">
                                    <?= FormatNo_($psn['kode']) . ' - ' . $psn['pelanggan'] ?>
                                </option>
                            <?php } ?>
                        </select>
                    </div>
