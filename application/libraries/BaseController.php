...
?>
	...
	function loadViewsAdmin($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL, $clickMenu = TRUE, $role = '')
	{
		...
		if ($clickMenu == FALSE) {
			...
			if ($role == '') {
				...
				$nav = BASE_DIR . "application/views/templatesAdm/sidebarD.php";
			}
		}
